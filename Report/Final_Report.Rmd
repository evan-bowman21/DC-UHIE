...
As seen from the Figure 1, the census tracts with the highest HSI levels fall within areas along the Anacostia River, also found within Wards 7 and 8. These census tracts are a vast contrast when compared to census tracts with low HSI levels found in the Northwest portion of the city. 
Having defined HSI as a metric that explains an individual's ability to adapt, cope, or recover from extreme heat, it is important to understand what specific demographic patterns exist that correlate with census tracts' HSI measurements. There is a clear trend of tracts with higher minority populations to have more adverse abilities to cope with intense heat (Fig. 2). Grouping the data based on majority minority census tracts further exemplifies this finding while also highlighting the magnitude of the difference (Fig. 3). 
