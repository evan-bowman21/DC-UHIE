...
The first model will be utilizing the best subsets regression strategy through the leaps package. The model was fitted and summary statistics are presented in the table below
```{r, include=FALSE}
hsi_model <- heat_full %>%
  select(P_POC:HSI)
